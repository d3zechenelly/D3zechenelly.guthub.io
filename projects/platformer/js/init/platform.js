(function (window) {
    ...
    platform.init = function (game) {
        ...
        // example:
        platform.create(300, 570, .85, .1);
        platform.create(600, 450, .85, .5);
        platform.create(0, 450, .85, .5);
        platform.create(0, 350, .85, .5);
        platform.create(600, 350, .85, .5);
        platform.create(300, 250, .85, .1);
